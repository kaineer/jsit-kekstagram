...
(function() {
  ...
  Resizer.prototype = {
    ...
    redraw: function() {
      ...
      var halfSide = (this._resizeConstraint.side) / 2 + this._ctx.lineWidth;
      ...
      // Внешний контур
      this._ctx.moveTo(-halfSide, -halfSide);
      this._ctx.lineTo(-halfSide, halfSide - (this._ctx.lineWidth * 1.5));
      this._ctx.lineTo(halfSide - (this._ctx.lineWidth * 1.5), halfSide - (this._ctx.lineWidth * 1.5));
      this._ctx.lineTo(halfSide - (this._ctx.lineWidth * 1.5), -halfSide);
    ...
    setConstraint: function(x, y, side) {
      ...
      // side = side || this._resizeConstraint.side;

      // this._contai.style.margin = '-' + (side / 2) + 'px 0 0 -' + (side / 2) + 'px';
